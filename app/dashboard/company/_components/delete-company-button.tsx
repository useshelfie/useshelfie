            ...
            <AlertDialogContent>
                <AlertDialogHeader>
                    ...
                    <AlertDialogDescription>
                        ...
                        <br/><strong className="mt-2 block">This feature is not fully implemented. Dependency checks and actual deletion logic are missing.</strong>
                    </AlertDialogDescription>
                </AlertDialogHeader>
                {error && (
                ...
                <AlertDialogFooter>
                    ...
                    <AlertDialogAction onClick={handleDelete} disabled={true || isDeleting} className="bg-destructive hover:bg-destructive/90">
