      ...
      <div className="flex items-center justify-center h-[calc(100vh-120px)]">
        <Card className="w-full max-w-md mx-auto">
          <CardHeader>
            ...
            <CardDescription>Catalogs help you organize products for different purposes or markets.</CardDescription>
          </CardHeader>
    ...
    <div className="p-6">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
        {catalogs?.map((catalog) => (
          <Link href={`/dashboard/${companyId}/catalogs/${catalog.slug}`} key={catalog.id} className="block group">
            <Card className="h-full transition-shadow hover:shadow-md">
              <CardHeader className="pb-2">
                <div className="flex justify-between items-start">
                  <CardTitle className="text-lg group-hover:text-primary transition-colors">{catalog.name}</CardTitle>
                  <Badge variant="outline">{(catalog as any).product_count || 0} products</Badge>
                </div>
