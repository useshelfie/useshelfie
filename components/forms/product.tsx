...
export function ProductForm({
	...
	const [productState, productFormAction] = useActionState(
		createProductAction,
		initialProductState
	) // Assuming this state management is correct
	...
	const handleNewCategoryCreated = (newCategory: Category) => {
		setAvailableCategories((prev) => {
			...
			if (
				...
				console.warn(
					`Attempted to add duplicate category ID: ${newCategory.id}`
				)
				return prev
			}
	...
	return (
		<Card className="w-full max-w-lg">
			...
			<CardHeader>
				...
				<CardDescription>
					Fill in the details and select categories.
				</CardDescription>
			</CardHeader>
			<form
				ref={productFormRef}
