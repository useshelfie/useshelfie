...
import { deleteCatalogAction, type CatalogFormState } from "@/app/dashboard/[company_id]/catalogs/actions"
...
export function DeleteCatalogButton({ companyId, catalogId, catalogName, className }: DeleteCatalogButtonProps) {
  ...
  const [isPending, startTransition] = useTransition(); // Optional: for finer loading state control
        ...
        <form action={formAction}>
          <AlertDialogHeader>
            ...
            <AlertDialogDescription>
              ...
              catalog "<strong>{catalogName}</strong>". Products within this catalog will
              <strong> not</strong> be deleted (deletion will fail if products exist).
            </AlertDialogDescription>
          </AlertDialogHeader>
          <AlertDialogFooter>
