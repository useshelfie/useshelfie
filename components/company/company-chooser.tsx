            ...
            {currentCompany ? (
              <>
                <Avatar className="w-5 h-5 mr-2">
                  <AvatarFallback>{currentCompany.name ? currentCompany.name[0].toUpperCase() : "?"}</AvatarFallback>
                </Avatar>
                {currentCompany.name}
              </>
            ) : (
              ...
              <Link href={href} key={company.id} passHref>
                <DropdownMenuItem
                  ...
                  <Avatar className="w-5 h-5">
                    <AvatarFallback>{company.name ? company.name[0].toUpperCase() : "?"}</AvatarFallback>
                  </Avatar>
                  {company.name}
                </DropdownMenuItem>
              </Link>
